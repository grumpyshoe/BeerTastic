...
package com.grumpyshoe.beertastic.presentation.features.home.viewmodel
...
class HomeViewModel(
    ...
    val beerList =
        combine(_beerList, getFavorites()) { beers, favorites ->
    ...
    private fun Beer.toBeerUiItem(): BeerUIItem = BeerUIItem(
        id = id,
        name = name,
